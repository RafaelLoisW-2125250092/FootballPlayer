    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nama.trim().equals(""))  //trim mengabaikan spasi untuk menghapus spasi secara otomatis
                {
                    ...
                    if(eks == -1)
                    {
                        ...
                        etNama.requestFocus();      //balikin ke etNama
                    }else {
                        Toast.makeText(TambahActivity.this, "Berhasil Menambah Data Player", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
            }
